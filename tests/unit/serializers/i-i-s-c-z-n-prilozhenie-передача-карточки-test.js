...
moduleForModel('i-i-s-c-z-n-prilozhenie-передача-карточки', 'Unit | Serializer | i-i-s-c-z-n-prilozhenie-передача-карточки', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-c-z-n-prilozhenie-передача-карточки',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
